...
<xsl:template match="svg:g">
	...
	<xsl:call-template name="u1035"/>
	</xsl:copy>
</xsl:template>

<xsl:template name="u1035">
...
<xsl:variable name="hookInnerDy" select="math:sin($hookStartAngle) * $waYInnerRadius"/>
    ...
    <xsl:call-template name="corner">
        ...
        <xsl:with-param name="y" select="$latinAscent - $waYOuterRadius - ($thickness + $hookOuterDy + $hookInnerRadius * math:sin($hookStartAngle))"/>
	...
	<xsl:call-template name="corner">
        ...
        <xsl:with-param name="nextY" select="-$latinAscent + $waYOuterRadius + $hookOuterDy + $hookInnerRadius * math:sin($hookStartAngle)"/>
	</xsl:call-template>
