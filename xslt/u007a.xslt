...
<xsl:template name="u007a">
    ...
    <xsl:variable name="lineAngle" select="math:atan((2 * $waYOuterRadius - 2 * $thickness) div (2 * $waXOuterRadius))"/>
	...
	<xsl:call-template name="line">
        ...
        <xsl:with-param name="y" select="-(2 * $waYOuterRadius - 2 * $thickness)"/>
    </xsl:call-template>
