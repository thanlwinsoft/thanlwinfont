...
<xsl:variable name="advance" select="$narrowConsWidth + $preGuard + $thickness + 2 * $postGuard"/>
...
<xsl:template match="svg:g">
	...
	<xsl:call-template name="u1012">
		<xsl:with-param name="xOffset" select="($preGuard + $thickness + $postGuard + $waXOuterRadius) div $med1012Scale - $waXOuterRadius"/>
