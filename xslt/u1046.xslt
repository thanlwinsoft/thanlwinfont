...
<xsl:template match="svg:g">
	...
	<xsl:call-template name="u1046"/>
	</xsl:copy>
</xsl:template>

<xsl:template name="u1046">
    ...
    <xsl:call-template name="Move">
        ...
        <xsl:with-param name="y" select="$ascent - $waYOuterRadius"/>
    </xsl:call-template>
    ...
    <xsl:text>l0,</xsl:text><xsl:value-of select="- $ascent + 2 * $waYOuterRadius"/>
    <xsl:call-template name="arc">
        <xsl:with-param name="rx" select="$waXOuterRadius"/>
        <xsl:with-param name="ry" select="$waYOuterRadius"/>
        <xsl:with-param name="axisRotation" select="0"/>
