...
<xsl:template name="u0067">
	...
	<xsl:element name="path" use-attribute-sets="pathAttribs">
	    <xsl:attribute name="d">
			...
			<xsl:call-template name="line">
				<xsl:with-param name="x" select="0"/>
				<xsl:with-param name="y" select="-(1 - math:sin($intersectAngle)) * $waYOuterRadius - ($descent - $waYOuterRadius)"/>
			</xsl:call-template>
			<xsl:call-template name="arc">
			...
			<xsl:call-template name="line">
				<xsl:with-param name="x" select="0"/>
				<xsl:with-param name="y" select="2 * $waYOuterRadius + ($descent - $waYOuterRadius)"/>
			</xsl:call-template>
