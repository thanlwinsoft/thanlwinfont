...
<xsl:template match="svg:g">
	...
	<xsl:call-template name="u103c_narrow_upper_u103d"/>
	</xsl:copy>
</xsl:template>

<xsl:template name="u103c_narrow_upper_u103d">
	...
	<xsl:call-template name="corner">
		<xsl:with-param name="x" select="-$topLength - $cornerOuterRadius"/>
	...
	<xsl:call-template name="Move">
        <xsl:with-param name="x" select="$waXOuterRadius +$preGuard + $cornerOuterRadius"/>
