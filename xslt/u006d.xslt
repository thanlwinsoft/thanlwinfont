...
<xsl:template name="u006d">
	...
	<xsl:variable name="middleIntersectAngle" select="math:acos(($waXOuterRadius - .5 * $thickness) div $waXOuterRadius)"/>
	<xsl:element name="path" use-attribute-sets="pathAttribs">
	    <xsl:attribute name="d">
			...
			<xsl:call-template name="arc">
				...
				<xsl:with-param name="x" select="$waXOuterRadius *(math:cos($middleIntersectAngle) + math:cos($intersectAngle))"/>
			...
			<xsl:call-template name="arc">
				...
				<xsl:with-param name="large" select="0"/>
				<xsl:with-param name="clockwise" select="0"/>
				<xsl:with-param name="x" select="$waXOuterRadius *(math:cos($middleIntersectAngle) +1)"/>
