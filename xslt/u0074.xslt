...
<xsl:template match="svg:g">
	...
	<xsl:call-template name="u0074"/>
	</xsl:copy>
</xsl:template>


<xsl:template name="u0074">
	...
	<xsl:element name="path" use-attribute-sets="pathAttribs">
	    <xsl:attribute name="d">
			...
			<xsl:call-template name="line">
				...
				<xsl:with-param name="y" select="2 * $waYOuterRadius - $latinAscent"/>
			</xsl:call-template>
			<xsl:call-template name="line">
			...
			<xsl:call-template name="line">
				<xsl:with-param name="x" select="0"/>
				<xsl:with-param name="y" select="-$waYInnerRadius - .5 * $waYOuterRadius"/>
			</xsl:call-template>
			...
			<xsl:call-template name="line">
				<xsl:with-param name="x" select="0"/>
				<xsl:with-param name="y" select="$latinAscent - 2 * $waYOuterRadius"/>
			</xsl:call-template>
