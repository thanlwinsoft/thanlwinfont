...
<axsl:template match="svg:g">
	<axsl:copy use-attribute-sets="gAttribs">
		<axsl:call-template name="{concat($kinzi, '_', $base, '_', $medial , '_u1031')}"/>
	</axsl:copy>
</axsl:template>

<axsl:template name="{concat($kinzi, '_', $base, '_', $medial , '_u1031')}">
