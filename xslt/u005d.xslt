...
<xsl:template name="u0049">
    ...
    <xsl:call-template name="Move">
        <xsl:with-param name="x" select="$xOffset + $preGuard + 3 * $thickness"/>
    ...
    <xsl:text>l0,</xsl:text><xsl:value-of select="-$latinDescent -$latinAscent + 2 * $thickness"/>
    <xsl:text>l</xsl:text><xsl:value-of select="-2 * $thickness"/><xsl:text>,0</xsl:text>
    <xsl:text>l0,</xsl:text><xsl:value-of select="-$thickness"/>
    <xsl:text>l</xsl:text><xsl:value-of select="3 * $thickness"/>
    <xsl:text>,0</xsl:text>
	<xsl:text>l0,</xsl:text><xsl:value-of select="$latinAscent + $latinDescent"/>
