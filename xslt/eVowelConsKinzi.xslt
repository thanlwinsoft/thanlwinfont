...
<axsl:template match="svg:g">
	<axsl:copy use-attribute-sets="gAttribs">
		<axsl:call-template name="{concat('u1004_u103a_u1039_',$base, '_u1031')}"/>
	</axsl:copy>
</axsl:template>

<axsl:template name="{concat('u1004_u103a_u1039_',$base, '_u1031')}">
	...
	<axsl:call-template name="u1004_u103a_u1039">
		<axsl:with-param name="xOffset" select="$advance"/>
		<axsl:with-param name="yOffset" select="0"/>
	</axsl:call-template>
</axsl:template>
